          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color:
                    producto.esGratis ? const Color(0xFFFFF8D6) : Colors.white,
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          'Tipo de bebida: ${producto.tipoBebida}',
                          style: const TextStyle(
                            fontSize: 16,
                  ...
                  Row(
                    children: [
                      ...
                      const SizedBox(width: 8),
                      Text(
                        'Cantidad: ${producto.cantidadMl} ml',
                        style: const TextStyle(
                          fontSize: 16,
                          fontWeight: FontWeight.w600,
                        ),
              ...
              child: ElevatedButton.icon(
                ...
                onPressed: () {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                      content: Text(
                        '${producto.nombre} agregado x$cantidad 🛒',
                      ),
                      backgroundColor: AppColors.lilaOscuro,
